with open('src/pages/auth/SellerRegister.tsx', 'r') as f:
    content = f.read()

new_content = """import { useState, useRef } from 'react';
      ...
      <div className="max-w-2xl w-full space-y-8 bg-white p-8 rounded-xl shadow-sm border border-slate-200">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="text-sm text-center mt-4 flex flex-col space-y-2">
            ...
            <Link to="/register" className="font-medium text-slate-500 hover:text-slate-700">
...
with open('src/pages/auth/SellerRegister.tsx', 'w') as f:
    f.write(new_content)
